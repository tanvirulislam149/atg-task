         ...
         >
            <Card>
               <Card.Img
                  variant="top"
                  height={220}
                  src="https://complitlang.ucr.edu/wp-content/uploads/2017/09/juha-lakaniemi-445378-1500x430.jpg"
               />
               <Card.Body>
                  <Card.Title className="card-title">🔬️ Education </Card.Title>
                  <div className="d-flex justify-content-between">
                     <div>
                        <p className="card-bold-text">
                  ...
                  <Card.Text className="card-normal-text">
                  ...
                  <div className="d-flex justify-content-between">
                     <div className="d-flex align-items-center">
                        <img
                           ...
                           alt="Avatar"
                        />
                        <p className="avatar-text">Sara West</p>
                     </div>
                     <div>
                        <div className="d-flex align-items-center">
                           <svg
